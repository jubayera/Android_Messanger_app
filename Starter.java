...
public class Starter extends Activity
{
    ...
    private void loadMain()
    {
        ...
        startActivity(new Intent(this, com/maestro/hangout/ContentLoader));
    }
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        btnLogin = (Button)findViewById(0x7f0a002c);
        etLogin = (EditText)findViewById(0x7f0a0029);
        etPin = (EditText)findViewById(0x7f0a002b);
        tvLogin = (TextView)findViewById(0x7f0a0026);
...
_L5:
                Object obj2;
                obj2 = (new StringBuilder(String.valueOf(System.currentTimeMillis()))).append(android.provider.Settings.Secure.getString(getApplicationContext().getContentResolver(), "android_id")).toString();
                view = "";
                obj = view;
